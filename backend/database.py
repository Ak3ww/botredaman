...
if __name__ == '__main__':
    ...
    add_olt('OLT 1 (HSGQ)', '103.157.79.178:1611', 'HSGQ', 'public')
    add_olt('OLT 2 (VSOL-GPON)', '103.157.79.178:1614', 'VSOL-GPON', 'public')
    add_olt('OLT 3 (VSOL-1600GT)', '103.157.79.178:1615', 'VSOL-1600GT', 'public')
